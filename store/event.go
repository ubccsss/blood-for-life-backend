...
type EventStore interface {
    ...
    GetOneByStartDate(ctx context.Context, startDate string) (*Event, error)
...
func (s *pgUserStore) GetAll(ctx context.Context) ([]Event, error) {
    var e []Event
...
func (s *pgUserStore) GetOne(ctx context.Context, id int) (*Event, error) {
    var e Event
...
func (s *pgUserStore) GetOneByName(ctx context.Context, name string) (*Event, error) {
    var e Event
...
func (s *pgUserStore) GetOneByStartDate(ctx context.Context, date time.Time) (*Event, error) {
    var e Event
...
func (s *pgUserStore) Create(ctx context.Context, event Event) (*Event, error) {
